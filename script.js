...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (openContactModalBtn) {
        openContactModalBtn.addEventListener('click', () => toggleContactModal(true));
    }

    if (closeContactModalBtn) {
        closeContactModalBtn.addEventListener('click', () => toggleContactModal(false));
    }
    ...
    async function startHeroAnimations() {
        ...
        if (subtitleEl && subtitleCursor) {
            ...
            await typeText(subtitleEl, "Data Analyst & AI Integration Specialist", 80);
        ...
        if (aboutEl && aboutCursor) {
            ...
            await typeText(aboutEl, "I leverage Advanced Python, SQL, and AI to build scalable solutions with speed and precision.", 50);
        }
    }
